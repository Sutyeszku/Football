...
<div class="container mt-5">
  <div class="row playerCards" style="display: flex; justify-content: center;">
    <div class="col-12 text-center">
      <h2 class="text-center">Goalkeepers</h2>
      <div class="row goalkeepers" style="display: flex; justify-content: center;"></div>
    </div>

    <div class="col-12 text-center">
      <h2 class="text-center">Defenders</h2>
    ...
    <div class="col-12 text-center">
      <h2 class="text-center">Midfielders</h2>
    ...
    <div class="col-12 text-center">
      <h2 class="text-center">Attackers</h2>
